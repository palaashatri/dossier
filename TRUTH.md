...
Debug JVM unit tests          PASS — 838 tests / 137 result XML files / 0 failures / 0 errors / 0 skips
uiTest JVM unit tests         PASS — 838 tests / 137 result XML files / 0 failures / 0 errors / 0 skips
...
uiTest APK                    PASS — 243,987,820 bytes / SHA-256 5DB613590531D779D0F6F07ED42307F836B38DF32CFF5C9D0C44E3D6BDD5F6EF
...
Graph evidence-ledger audit    PASS — 13 focused JVM tests; dangling canonical, graph-edge and graph-entity evidence IDs fail closed when a non-empty ledger is supplied, graph-entity truncation is inconsistent, and legacy empty-ledger cases remain fail-soft
...
Graph relation normalization PASS — 12 EntityGraphBuilder + 6 GraphSchemaV2 + 13 GraphEvidenceReconciliation + 3 CaseEvidenceIdMigration JVM tests; case/whitespace variants merge without dropping provenance and entity evidence IDs are trimmed/migrated/deduplicated/bounded/reconciled
