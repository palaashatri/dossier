...
Debug JVM unit tests          PASS — 829 tests / 137 result XML files / 0 failures / 0 errors / 0 skips
uiTest JVM unit tests         PASS — 829 tests / 137 result XML files / 0 failures / 0 errors / 0 skips
Android-test Kotlin compile  PASS — `compileUiTestAndroidTestKotlin`
Debug APK                     PASS — 119,485,599 bytes / SHA-256 F561594EEABC6D420D0A2CD7350D11D3A4D6B7B8103866447B44D1360462F386
uiTest APK                    PASS — 243,769,523 bytes / SHA-256 EB17F51C8B7121AD084100C8A0B7C2790A243C0B0958CF2AEA9AB642E9105D3B
...
The latest focused additions keep the pinned executable-rule health report separate from the 78 authored-provider report, normalize graph relation keys by trim/case-insensitive comparison without rewriting the first persisted relation spelling or dropping evidence IDs, persist a bounded face-consistency result only across a stable model commitment, and confine CaseStore deletion paths to safe case IDs and the canonical case directory.
