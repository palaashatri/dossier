...
Debug JVM unit tests                PASS — 846 tests / 138 result XML files / 0 failures, errors, or skips
uiTest JVM unit tests               PASS — 846 tests / 138 result XML files / 0 failures, errors, or skips
